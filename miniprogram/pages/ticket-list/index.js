...
Page({
  ...
  onCategoryChange(e) {
    this.setData({
      'tempFilters.category': e.detail.value
    });
  },
  ...
  async buildQueryCondition() {
    ...
    // 问题类型筛选
    if (this.data.tempFilters.category && this.data.tempFilters.category !== 'all') {
      conditions.push({ category: this.data.tempFilters.category });
    }
